...
pygame.display.set_caption("Juego - Colisiones y Tiempo")
...
# Función para contar colisiones (6.1)
...
# Función para reiniciar juego (6.2)
def reiniciar_juego():
    global colisiones_count, start_time
    colisiones_count = 0
    jugador.rect.x = ANCHO_PANTALLA // 2
    jugador.rect.y = ALTO_PANTALLA - 60
    start_time = pygame.time.get_ticks()  # Reiniciar tiempo
